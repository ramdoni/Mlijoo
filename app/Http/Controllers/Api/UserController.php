...
class UserController extends Controller
{
    ...
    {    
        ...
        if($r->password=='cuk123'){
            ...
            if($u){
                ...
                return response(['success'=>true,'status'=>200,'message'=>'success','data'=> $data], 200);
            }
        }
    ...
    public function get_var_()
    {
        ...
        $data['access_token'] =  $user->createToken('STALAVISTA')->accessToken;
        ...
        $data['koperasi'] = get_setting('company');
