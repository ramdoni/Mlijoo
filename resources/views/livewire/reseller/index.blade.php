...
@push('action')
    <div class="text-right">
        <div class="btn-group" role="group">
            <button id="btnGroupDrop1" type="button" class="btn btn btn-outline-secondary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Action</button>
        ...
        <a href="{{ route('reseller.create') }}" class="btn btn-info"><i class="fa fa-plus"></i> Tambah Reseller</a>
    </div>
@endpush
    ...
    <div class="col-lg-3 col-md-6">
        <div class="card top_counter currency_state">
            <div class="body">
                ...
                <div class="content">
                    <div class="text">Total Reseller</div>
                    <h5 class="number">{{format_idr($totals['total_reseller'])}}</h5>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <tbody>
                            ...
                            @foreach($data as $k => $item)
                                <tr>
                                    ...
                                    <td><a href="{{route('reseller.edit',['data'=>$item->id])}}">{{ $item->nama }}</a></td>
